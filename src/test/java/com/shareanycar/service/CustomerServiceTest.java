...
public class CustomerServiceTest extends HK2Runner{
	...
	public void postCommentOnCar(){
		ownerService.create("Owner", "Owner", "USA", "Chicago", "7(777)777-77-77", "test@test.com", "letmein");
		Owner owner = ownerService.findOwnerByEmail("test@test.com");
		
		carService.create(owner.getId(),"brand name","model name", "BMW", "brand new", 2017, "USA", "Chicago");
	...
	public void removeComment(){
		...
		owner = ownerService.findOwnerByEmail("test@test.com");
		Car car = owner.getCars().iterator().next();
